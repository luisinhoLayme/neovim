return {
    ...
    local palette = require("features.ui.colors")
		...
		local nbg = palette.nbg
		local sbg = palette.sbg
		local tfg = palette.tfg
		local nbgl = palette.nbgl
		...
		local components = {
			...
			index = {
				...
				fg = function(buffer)
					return buffer.is_focused and nbg or tfg -- mind tfg
				end,
				truncation = { priority = 1 },
			},
			...
			filename = {
				...
				fg = function(buffer)
					return buffer.is_focused and nbg or tfg -- mind tfg "#FFFFFF"
				end,
				truncation = {
					priority = 2,
					direction = "left",
			...
			left_half_circle = {
				text = "", --   
				fg = function(buffer)
					return buffer.is_focused and sbg or  nbgl --nbg
				end,
				bg = "",  --nbg, --abg,
				truncation = { priority = 1 },
			},
